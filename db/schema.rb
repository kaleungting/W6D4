...
ActiveRecord::Schema.define(version: 2020_02_27_222422) do
  ...
  create_table "artwork_collections", force: :cascade do |t|
    ...
    t.index ["collection_name"], name: "index_artwork_collections_on_collection_name"
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "favorited"
    t.integer "artwork_collection_id"
    t.index ["artist_id"], name: "index_artworks_on_artist_id"
    t.index ["artwork_collection_id"], name: "index_artworks_on_artwork_collection_id"
